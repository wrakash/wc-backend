...
public class GroupFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.all_chat_user, container, false);
        context = rootView.getContext();

        View plus = (View) rootView.findViewById(R.id.plus);
        ...
        recyclerListGroups = (RecyclerView) rootView.findViewById(R.id.recycleListGroup);
...
class ListGroupsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        final String unreadMessageCount = listGroup.get(position).groupInfo.get("unreadMessage");
        final String lastMessage = listGroup.get(position).groupInfo.get("lastMessage");
        final String timeStatus = listGroup.get(position).groupInfo.get("timeStatus");
        final String avata = listGroup.get(position).groupInfo.get("iconGroup");
       ...
       /* ((ItemGroupViewHolder) holder).btnMore.setOnClickListener(new View.OnClickListener() {
        ...
        ((LinearLayout)((ItemGroupViewHolder) holder).txtGroupName.getParent()).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  intent.putExtra(StaticConfig.INTENT_KEY_CHAT_FRIEND, avata);
...
class ItemGroupViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
    ...
    public CircleImageView iconGroup;
    public TextView timeStatus;
    public ItemGroupViewHolder(View itemView) {
        super(itemView);
        itemView.setOnCreateContextMenuListener(this);
        iconGroup = (CircleImageView) itemView.findViewById(R.id.icon_avata);
        txtGroupName = (TextView) itemView.findViewById(R.id.groupChat);
