package com.android.whichcollege.data;
...
public class GroupDB {
    ...
    public void addGroup(Group group) {
        ...
        values.put(FeedEntry.COLUMN_GROUP_ICON, group.groupInfo.get("groupIcon"));
        values.put(FeedEntry.COLUMN_GROUP_DESCRIPTION, group.groupInfo.get("groupDescription"));
    ...
    public Group getGroup(String id){
        ...
        while (cursor.moveToNext()) {
            ...
            newGroup.groupInfo.put("groupIcon", icon);
            newGroup.groupInfo.put("groupDescription", description);
    ...
    public static class FeedEntry implements BaseColumns {
        ...
        static final String COLUMN_GROUP_ICON = "groupIcon";
        static final String COLUMN_GROUP_DESCRIPTION = "groupDescription";
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + FeedEntry.TABLE_NAME + " (" +
                    ...
                    FeedEntry.COLUMN_GROUP_ICON + TEXT_TYPE + COMMA_SEP +
                    FeedEntry.COLUMN_GROUP_DESCRIPTION + TEXT_TYPE + COMMA_SEP +
